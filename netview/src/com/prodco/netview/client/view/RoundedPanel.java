...
public class RoundedPanel extends Composite
  {
  private static int[] MARGINS = new int[]{5, 3, 2, 1};
  ...
  private class RoundedSlice extends Widget
    ...
    public void addLine ( int row, String color )
      ...
      DOM.setStyleAttribute( line, "marginRight", MARGINS[row]
        + "px" );
      DOM.setStyleAttribute( line, "marginLeft", MARGINS[row]
        + "px" );
  ...
  public static final int ROUND_BOTH = ROUND_TOP
    | ROUND_BOTTOM;
  ...
  public void setWidget ( Widget w )
    ...
    for ( int i = 0; i < MARGINS.length; ++i )
      ...
      bottomSlice.addLine( MARGINS.length
        - i - 1, color );
      }
