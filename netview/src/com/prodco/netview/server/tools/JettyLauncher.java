package com.prodco.netview.server.tools;
...
public class JettyLauncher extends ServletContainerLauncher {
  ...
  /**
   * Subclasses {@link JDTCompilerAdapter} to set default Java 1.5 compatibility
   * if not otherwise specified.
   */
  public static final class JDTCompiler15 extends JDTCompilerAdapter
    {
    @Override
